...
public class SistemaAnimacion : MonoBehaviour
{
    ...
    [SerializeField] private AnimationCurve curvaAnimaciónRápida;
    ...
    public static float EvaluarCurvaRápida(float tiempo)
    {
        return instancia.curvaAnimaciónRápida.Evaluate(tiempo);
    }
